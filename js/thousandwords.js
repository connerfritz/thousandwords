define(function () {
  ...
  ThousandWords.prototype = {
    ...
    resizeImage: function() {
      ...
      if (width > height) {
        if (width > this.options.canvasWidth) {
          width = this.options.canvasWidth;
          this.original.scale = this.options.canvasWidth / this.image.width;
          height *= this.original.scale;
        }
      } else {
        if (height > this.options.canvasHeight) {
          this.original.scale = this.options.canvasHeight / this.image.height;
